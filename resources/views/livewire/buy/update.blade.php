<div>
    <div class="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Editar compra</h1>
    </div>
    <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div class="overflow-hidden shadow sm:rounded-md">
            <div class="bg-white px-4 py-5 sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        <label for="datePurchase" class="block text-sm font-medium text-gray-700">
                            Fecha de compra
                        </label>
                        <input type="date" name="datePurchase" wire:model="datePurchase" id="datePurchase"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        focus:ring-indigo-500 sm:text-sm">
                            ...
                            @foreach($products as $item)
                                <option value="{{ $item->slug }}" {{ ($item->slug == $product) ? 'selected' : '' }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="amount" class="block text-sm font-medium text-gray-700">
                            Unidades o cantidad que se compro del producto
                        </label>
            ...
            <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                ...
                focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" wire:click="update">Guardar
                </button>
            </div>
        </div>
    </div>
