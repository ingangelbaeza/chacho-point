<div>
    <div class="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Listado de ventas</h1>
    </div>
                                    ...
                                    <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                        ...
                                        text-right">
                                            <div class="flex justify-center">
                                                <a href="{{ route('sale.update', $item->slug) }}" class="mr-3">
                                                ...
                                                <button onclick="Livewire.emit('openModal', 'sale.delete',
